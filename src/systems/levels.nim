...
const level11* = Level(
  ...
  movingPlatforms: @[
    MovingPlatform(waypoints: @[(x: 520.0, y: 460.0), (x: 520.0, y: 280.0)],
                   width: 100.0, height: 20.0, speed: 54.0,
                   pingPong: true, forward: true,
                   x: 520.0, y: 460.0, prevX: 520.0, prevY: 460.0),
  ],
  levelWidth: 1000.0,
  levelHeight: 500.0,
)
...
const level12* = Level(
  ...
  movingPlatforms: @[
    MovingPlatform(waypoints: @[(x: 200.0, y: 460.0), (x: 760.0, y: 460.0)],
                   width: 70.0, height: 20.0, speed: 196.0,
                   pingPong: true, forward: true,
                   x: 200.0, y: 460.0, prevX: 200.0, prevY: 460.0),
    MovingPlatform(waypoints: @[(x: 820.0, y: 360.0), (x: 820.0, y: 220.0)],
                   width: 90.0, height: 20.0, speed: 56.0,
                   pingPong: true, forward: true,
                   x: 820.0, y: 360.0, prevX: 820.0, prevY: 360.0),
  ],
  levelWidth: 1020.0,
  levelHeight: 500.0,
)
